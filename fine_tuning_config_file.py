...
DATA_DIR = 'GAN_dataset/' # to run with the sample dataset, just set to 'hymenoptera_data'

# DATALOADER PROPERTIES
BATCH_SIZE = 100 # Set as high as possible. If you keep it too high, you'll get an out of memory error.
